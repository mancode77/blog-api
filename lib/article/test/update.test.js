...
test('test update article', function () {
  var create = jest.fn(function (req) {
    ...
    if ((articles === null || articles === void 0 ? void 0 : articles.id) === (req === null || req === void 0 ? void 0 : (_req$path = req.path) === null || _req$path === void 0 ? void 0 : _req$path.id)) articles.author = 'Qwerty';
